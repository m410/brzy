 ...
 * @version $Id: $
 */
class Logging extends Merge[Logging]{
 ...
 *
 */
class Appender extends Merge[Appender] with Comparable[Appender] {
 ...
 *
 */
class Logger extends Merge[Logger] with Comparable[Logger]{
  @BeanProperty var name:String =_
