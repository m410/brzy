...
class WebAppConfTest extends JUnitSuite {
  ...
  @Test def testJson() {
    ...
    assertEquals(15, wacFromJson.dependencies.size)
    ...
    assertEquals(7, wacFromJson.repositories.size)
