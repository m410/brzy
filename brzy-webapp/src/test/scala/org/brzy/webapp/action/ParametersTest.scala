...
class ParametersTest extends JUnitSuite {
  ...
  @Test def testMixedParams() {
    assertNotNull(parameters("id"))
    assertNotNull(parameters("lastName"))
    assertNotNull(parameters("firstName"))
//    assertNotNull(parameters("randomName"))

//    assertEquals(1,parameters.url("id").get.length)
    assertEquals("12321",parameters("id"))

    assertEquals(true,parameters.url.contains("id"))
    assertEquals("12321",parameters("id"))
