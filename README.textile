...
http://wiki.github.com/m410/brzy/

This is still a very early release but it's starting to take shape nicely.  Some of the
most difficult issues I have left half to do with the build system.  The mvc portion of
the code is almost ready.

Take a look at some of the modules here:
http://github.com/m410/brzy-modules

And a sample working webapp can be found here:
http://github.com/m410/brzy-examples/tree/master/squeryl-scalate/
