...
/**
 * Note that this was copied from here:<br>
 * <a href="http://www.java2s.com/Open-Source/Java-Document/Project-Management/quartz/org/quartz/CronExpression.java.htm">http://www.java2s.com/Open-Source/Java-Document/Project-Management/quartz/org/quartz/CronExpression.java.htm</a>
 * <br>
        ...
        try {
            ...
            if (exprOn <= DAY_OF_WEEK) {
                throw new ParseException(
                        "Unexpected end of expression.", expression
                                .length());
            }
            ...
            if (type == MONTH) {
                ...
                if (s.length() > i + 3) {
                    ...
                    if (c == '-') {
                        ...
                        try {
                            i += 4;
                            nthdayOfWeek = Integer.parseInt(s
                                    .substring(i));
            ...
            if (dayOfMSpec && !dayOfWSpec) { // get day by day of month rule
                ...
                if (lastdayOfMonth) {
                    if (!nearestWeekday) {
                        ...
                        int ldom = getLastDayOfMonth(mon, cl
                                .get(Calendar.YEAR));
                ...
                if (lastdayOfWeek) { // are we looking for the last XXX day of
                    ...
                    int lDay = getLastDayOfMonth(mon, cl
                            .get(Calendar.YEAR));
